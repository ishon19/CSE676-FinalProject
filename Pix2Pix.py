...
class SplitData(Dataset):
    ...
    def __getitem__(self, index) -> None:
        ...
        target_image = DataTransformation.tranform_mask(image=target_image)["image"]
...
def main(args) -> None:
    ...
    train_dataset = SplitData(root_dir=config.TRAIN_DIR)
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--cuda", default=False, help="Enable CUDA")
    argparser.add_argument("--invert", default=False,
                           help="learn the left side of the image")
    argparser.add_argument("--modelname", default=False, help="which model to load")
